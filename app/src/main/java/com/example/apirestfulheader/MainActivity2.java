...
public class MainActivity2 extends AppCompatActivity implements Response.Listener<JSONObject>,
    ...
    public void onErrorResponse(VolleyError error) {
        TextView Informacion = (TextView)findViewById(R.id.textresp);
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            TextView txtvolley = findViewById(R.id.textresp);
